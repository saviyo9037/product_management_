...
function ProductF({ initialValues = {}, onSubmit, isEdit = false }) {
  const validationSchema = Yup.object({
    ...
    stock:
     Yup.number().min(0, 'stock minimum 1').required('enter the stock')
  });
